    ...
    def get_data_transformer_object(self):
        try:
            ...
            cat_pipeline = Pipeline(steps=[
                ...
                # OneHotEncoder by default returns a sparse matrix. StandardScaler with_mean=True
                # cannot be applied to sparse matrices. Set with_mean=False to avoid centering.
