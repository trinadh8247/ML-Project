...
class PredictPipeline:
    ...
    def predict(self, features):
        try:
            ...
            raise CustomException("Error occurred during prediction", sys) from e
...
class CustomData:
    ...
    def get_data_as_dataframe(self):
        try:
            ...
            raise CustomException("Error occurred while converting custom data to DataFrame", sys) from e